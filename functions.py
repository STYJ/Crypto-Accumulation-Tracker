...
# Initializing a dictionary of coin ticker to tuple.
# tuple has the format (dict of exchange vol pair, time of update)
...
def getExchangeWithCache(coin, coin_to_exchanges):
    ...
    if not checkCoin(coin, coin_to_exchanges):
        ...
        # If more than 1 minute has passed, update cache
...
# Command to update database manually
